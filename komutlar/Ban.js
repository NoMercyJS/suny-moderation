...
if(!args[1] || isNaN(args[1])) return message.channel.send(new MessageEmbed()
.setDescription(`${message.author}, Geçerli bir ban yemiş kullanıcı ID'si belirtmelisin.`)
...
banlog.send(`**${kullanici.user.tag}** adlı kullanıcı başarıyla __${Knavesebep}__ Sebebiyle **${message.author.tag}** Tarafından yasaklandı.`);
}
