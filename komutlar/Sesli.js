...
if(!knave1) return message.channel.send(new MessageEmbed().setTimestamp().setColor('RANDOM').setDescription(`Bir @Mercy/ID Girmelisin Veya Kullanıcı Etiketlemelisin`))
if (knave1) {
    knave = knave;
}
if (knave2) {
